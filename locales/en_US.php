<?php 
/*
 * @version $Id: en_US.php 19330 2012-09-25 08:05:23Z moyo $ 
 -------------------------------------------------------------------------
...
$LANG['install'][66]="GLPI does not work with the magic_quotes_sybase option ; Please disable the option and retry"; 
...
$LANG['install'][75]="You must disable the Session_use_trans_id option in your php.ini"; 
...
$LANG['login'][27]="You must accept cookies to acces this application"; 
...
$LANG['ocsng'][43]="Access denied on OCSNG database (Needs write rights on hardware.CHECKSUM necessary)"; 
...
$LANG['plugins'][10]="Plugin is incompatible with this version of GLPI"; 
...
$LANG['setup'][158]="Unable to use LDAP as external source of connection"; 
...
$LANG['setup'][166]="Unable to use email server as external source of connection"; 
...
$LANG['setup'][179]="Unable to use CAS as external source of connection"; 
...
$LANG['setup'][199]="Remove the domain from logins, i.e. login@domain"; 
...
$LANG['setup'][310]="Unable to connect to site."; 
...
$LANG['setup'][610]="Required title of the ticket"; 
$LANG['setup'][611]="Required ticket content"; 
$LANG['setup'][612]="Required ticket category"; 
...
$LANG['setup'][661]="Unable to configure the notifications : please configure your email follow-up using the above configuration."; 
...
$LANG['update'][107]="You must now proceed to update your database content"; 
