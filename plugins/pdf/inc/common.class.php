...
/*
 * @version $Id: common.class.php 316 2012-03-15 10:59:36Z tsmr $
 -------------------------------------------------------------------------
   ...
   **/
   private function addHeader($ID) {
      ...
      if ($this->obj->getFromDB($ID) && $this->obj->can($ID,'r')) {
         ...
         //Altera��o Marcelo - T�tulo somente com o n�mero do chamado 
		 //$this->pdf->setHeader($this->obj->getTypeName()." - <b>$name</b>$entity");
		 $this->pdf->setHeader($this->obj->getTypeName()." - <b>$name</b>");
