...
/*
 * @version $Id: simplepdf.class.php 303 2011-11-08 11:38:25Z remi $
 -------------------------------------------------------------------------
...
class PluginPdfSimplePDF {
   ...
   private function setBackground() {
      ...
      $this->pdf->addJpegFromFile(GLPI_ROOT."/plugins/pdf/pics/fd_logo.jpg",25,$this->height-50,148,28); // 61x25
   ...
   public function displayTitle () {
	...
	/*//SUPRISERVICE*/
   public function displayTitleCustom ($content, $minline=1, $maxline=100) {
      ...
      $x = 15 + $this->pdf->getTextWidth(9, $name);
      ...
      while ($line!==false && $maxline>0) {
         ...
         if (!empty($line)) {
            $line = $this->pdf->addTextWrap($x,$this->start_tab,$this->width-$x-25,9,$line,(isset($this->align[$i]) ? $this->align[$i] : 'center'));
         }
         if (empty($line)) {
            $line = next($lines);
         }
