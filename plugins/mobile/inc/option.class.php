   ...
   public function getTable() {
	...
	public function showForm () {
      global $LANG, $CFG_GLPI;
		...
		/*//SUPRISERVICE*/
      $logoutUrl = $CFG_GLPI["root_doc"] . "/plugins/mobile/logout.php";
      echo "<div data-theme='c'>";
         echo "<a href='{$logoutUrl}' data-icon='delete' data-role='button' data-inline='true' rel='external' data-theme='a'>".$LANG['central'][6]."</a>";
         echo "<br /><br />";
