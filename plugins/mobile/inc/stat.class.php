...
class PluginMobileStat extends Stat {
   ...
   static function show($type,$date1,$date2,$start,$value,$value2="") {
      ...
      if (is_array($value)) {
         ...
         echo PluginMobileSearch::showHeaderItem($output_type,$LANG['stats'][13],$header_num, '#', 0, '', 7);
         ...
         for ($i=$start ; $i< $numrows && $i<($end_display) ; $i++) {
            ...
            $value[$i]['link'] = "<a href='stat.graph.php?id=".$value[$i]['id']."&amp;date1=$date1&amp;date2=".
            ...
            echo PluginMobileSearch::showItem($output_type,$value[$i]['link'],$item_num,$row_num, '', 7);
            ...
            echo PluginMobileSearch::showItem($output_type,$nb_opened,$item_num,$row_num, '', 7);
            ...
            echo PluginMobileSearch::showItem($output_type,$nb_solved,$item_num,$row_num, '', 7);
