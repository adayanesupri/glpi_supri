...
class PluginProjetProjet_Projet extends CommonDBRelation {
   ...
   public $items_id_1 = 'plugin_projet_projets_id_1';
   public $itemtype_2 = 'PluginProjetProjet';
   public $items_id_2 = 'plugin_projet_projets_id_2';
   ...
   **/
   static function displayLinkedProjetsTo ($ID, $notif = false) {
         ...
         foreach ($projets as $linkID => $data) {
            if ($notif) {
               ...
               if (!$_SESSION['glpiis_ids_visible']) {
                  echo $LANG['common'][2]."&nbsp;".$data['plugin_projet_projets_id']."&nbsp;:&nbsp;";
               }
   ...
   **/
   static function dropdownLinks($myname, $value=self::LINK_TO) {
      ...
      $tmp[self::LINK_TO]        = $LANG['plugin_projet'][44];
