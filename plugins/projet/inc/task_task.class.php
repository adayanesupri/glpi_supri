...
class PluginProjetTask_Task extends CommonDBRelation {
   ...
   public $itemtype_1 = 'PluginProjetTask';
   public $items_id_1 = 'plugin_projet_tasks_id_1';
   public $itemtype_2 = 'PluginProjetTask';
   public $items_id_2 = 'plugin_projet_tasks_id_2';
         ...
         foreach ($tasks as $linkID => $data) {
            ...
            if ($notif) {
               ...
               if (!$_SESSION['glpiis_ids_visible']) {
                  echo $LANG['common'][2]."&nbsp;".$data['plugin_projet_tasks_id']."&nbsp;:&nbsp;";
               }
   ...
   **/
   static function dropdownLinks($myname, $value=self::LINK_TO) {
      ...
      $tmp[self::LINK_TO]        = $LANG['plugin_projet'][58];
