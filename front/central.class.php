<?php
/*
 * @version $Id: central.class.php 17152 2012-01-24 11:22:16Z moyo $
 -------------------------------------------------------------------------
   ...
   **/
   static function showMyView() {
      ...
      if ($showticket) {
			/*//SUPRISERVICE*/
         echo "<tr><td class='top' width='450px'>";
         Ticket::showCentralList(0, "atendimento", false);
         echo "</td></tr>";
			//--
         echo "<tr><td class='top' width='450px'>";
         ...
         echo "</td></tr>";
                        /*//SUPRISERVICE*/
         echo "<tr><td class='top' width='450px'>";
         Ticket::showCentralList(0, "waiting1", false);
         echo "</td></tr>";

         echo "<tr><td class='top' width='450px'>";
         Ticket::showCentralList(0, "waiting4", false);
         echo "</td></tr>";

         echo "<tr><td class='top' width='450px'>";
         Ticket::showCentralList(0, "approbation", false);
         echo "</td></tr>";

         echo "<tr><td class='top' width='450px'>";
         Ticket::showCentralList(0, "approbation1", false);
         echo "</td></tr>";
			//--
      }
   ...
   static function showGroupView() {
      ...
      if (Session::haveRight('show_group_ticket','1')) {
         ...
         echo "</td></tr>";
			...
			/*//SUPRISERVICE*/
         echo "<tr><td  class='top' width='450px'><br>";
         Ticket::showCentralList(0, "atendimento", true);
         echo "</td></tr>";
			//--
         echo "<tr><td  class='top' width='450px'><br>";
         Ticket::showCentralList(0, "waiting", true);
         echo "</td></tr>";
         		/*//SUPRISERVICE*/
         echo "<tr><td  class='top' width='450px'><br>";
         Ticket::showCentralList(0, "waiting1", true);
         echo "</td></tr>";

         echo "<tr><td  class='top' width='450px'><br>";
         Ticket::showCentralList(0, "waiting4", true);
         echo "</td></tr>";

         echo "<tr><td  class='top' width='450px'><br>";
         Ticket::showCentralList(0, "approbation", true);
         echo "</td></tr>";

         echo "<tr><td  class='top' width='450px'><br>";
         Ticket::showCentralList(0, "approbation1", true);
         echo "</td></tr>";
			//--
      }
