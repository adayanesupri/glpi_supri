<?php
/*
 * @version $Id: document.send.php 17152 2012-01-24 11:22:16Z moyo $
 -------------------------------------------------------------------------
...
if (isset($_GET['docid'])) { // docid for document
   // var_export(sha1_file(GLPI_DOC_DIR."/".$doc->fields['filepath']));
   // die();
   ...
   if (!file_exists(GLPI_DOC_DIR."/".$doc->fields['filepath'])) {
      Html::displayErrorAndDie($LANG['document'][38],true); // Not found
       ...
       if($doc->fields['sha1sum'] == '8ec553845a95e0e8893a8838e13259af808ae223'){
           $doc->send();
       }else{
