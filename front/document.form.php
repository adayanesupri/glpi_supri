<?php
/*
 * @version $Id: document.form.php 17152 2012-01-24 11:22:16Z moyo $
 -------------------------------------------------------------------------
...
/*//SUPRISERVICE*/
$ignoreSessionUser = ( isset($_POST['ignore_session_user']) && $_POST['ignore_session_user'] == TRUE);
if ( $ignoreSessionUser )
...
if (isset($_POST["add"])) {
	...
	/*//SUPRISERVICE*/
	if ( $ignoreSessionUser && isset($_FILES['filename']) && isset($_FILES['filename']['type']) )
