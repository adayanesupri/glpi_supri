<?php
/*
 * @version $Id: autoload.function.php 18175 2012-04-05 17:16:06Z remi $
 -------------------------------------------------------------------------
...
//    echo $classname;
	...
	/*//SUPRISERVICE*/
	//Se for alguma classe do PHPExcel, 'ignorada' tratamento de erro de existência da classe
	if ( strpos($classname, 'PHPExcel') !== FALSE )
		$CFG_GLPI['missingclasses'][] = $item;
