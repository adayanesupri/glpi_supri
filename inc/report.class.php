<?php
/*
 * @version $Id: report.class.php 17904 2012-03-20 08:51:55Z tsmr $
 -------------------------------------------------------------------------
...
class Report {
   ...
   static function title() {
      ...
      if (Session::haveRight("contract","w")) {
         $report_list["Tarifacao"]["name"] = $LANG['tarifacao'][40];
         $report_list["Tarifacao"]["file"] = "report.tarifacao.php";
      }
      ...
      if (Session::haveRight("reservation_central","r")) {
         ...
         $report_list["reservation"]["file"] = "report.reservation.php";
                ...
                /*//SUPRISERVICE*/
      if (Session::haveRight("contract","w")) {
         $report_list["Telefonia"]["name"] = $LANG['telefonia'][1];
         $report_list["Telefonia"]["file"] = "report.telefonia.php";
      }
