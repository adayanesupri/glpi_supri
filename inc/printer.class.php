...
/*
 * @version $Id: printer.class.php 19325 2012-09-25 07:37:15Z moyo $
  -------------------------------------------------------------------------
...
class Printer extends CommonDBTM {
    ...
    function defineTabs($options = array()) {
        ...
        /* //SUPRISERVICE */
        $this->addStandardTab('Fusioninventory_Printerlogs', $ong, $options);
    ...
    function showForm($ID, $options = array()) {
        ...
        echo "<td>";
        if ($this->can($ID, 'w')) {
            Dropdown::showGlobalSwitch($this->fields["id"], array('withtemplate' => $withtemplate,
        ...
        echo "</td>";
        echo "<input type='hidden' name='comment_compare' value='" .
        $this->fields["comment"] . "'>";
    ...
    function addPrinter($name, $manufacturer, $entity, $comment = '') {
        ...
        $sql = "SELECT `id`
              ...
              WHERE `manufacturers_id` = '$manufacturer_id'
                    AND `name` = '$name' " .
                getEntitiesRestrictRequest('AND', 'glpi_printers', 'entities_id', $entity, true);
