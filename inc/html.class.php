<?php
/*
 * @version $Id: html.class.php 18866 2012-07-10 07:39:42Z moyo $
 -------------------------------------------------------------------------
...
class Html {
   ...
   **/
   static function includeHeader($title='') {
      ...
      echo "\n<html><head><title>Supridesk - ".$title."</title>";
      ...
      echo "<link rel='shortcut icon' type='images/x-icon' href='".
             $CFG_GLPI["root_doc"]."/pics/favicon3.ico' >\n";
		
		/*//SUPRISERVICE*/
		echo "<script type='text/javascript' src='". $CFG_GLPI["root_doc"]."/lib/jquery/jquery-1.8.2.min.js'></script>\n";
		echo "<script type='text/javascript' src='". $CFG_GLPI["root_doc"]."/lib/jquery/jquery.gmap.js'></script>\n";
		echo "<script type='text/javascript' src='http://maps.googleapis.com/maps/api/js?sensor=true&v=3.10&libraries=geometry'></script>\n";
		//echo "<script type='text/javascript' src='http://google-maps-utility-library-v3.googlecode.com/svn/trunk/markermanager/src/markermanager.js'></script>\n";
		//echo "<script type='text/javascript' src='http://google-maps-utility-library-v3.googlecode.com/svn/trunk/infobox/src/infobox.js'></script>\n";
		echo "<script type='text/javascript' src='". $CFG_GLPI["root_doc"]."/lib/googlecode/markermanager.js'></script>\n";
		echo "<script type='text/javascript' src='". $CFG_GLPI["root_doc"]."/lib/googlecode/infobox.js'></script>\n";
   ...
   **/
   static function header($title, $url='', $sector="none", $item="none", $option="") {
      ...
      if (Session::getForcePasswordChange()) {
         Session::addMessageAfterRedirect($LANG['supriservice'][2], true, WARNING);
			Html::redirect($CFG_GLPI["root_doc"] . "/front/preference.php");
      }
		//--
      ...
      /*//SUPRISERVICE*/
      if ((Session::haveRight("cartridge_kits","r")) ||
          (Session::haveRight("cartridge_kits","w"))) {
         $menu['inventory']['content']['cartridge_kit']['title']            = $LANG['Menu'][103];
         $menu['inventory']['content']['cartridge_kit']['shortcut']         = '';
         $menu['inventory']['content']['cartridge_kit']['page']             = '/front/cartridge_kit_supridesk.php';
         //$menu['inventory']['content']['cartridge_kit']['links']['search']  = '/front/cartridge_kit.php';
         //$menu['inventory']['content']['cartridge_kit']['links']['summary'] = '/front/cartridge_kit.php';
      }
      if (Session::haveRight("cartridge_kits","w")) {
         $menu['inventory']['content']['cartridge_kit']['links']['add']
                                 = '/front/cartridge_kit_supridesk.form.php';
      }      
      
       
       if (Session::haveRight("transport","r")) {
            $menu['inventory']['content']['transport']['title']  = $LANG['Menu'][105];  
            $menu['inventory']['content']['transport']['shortcut']        = '';
            $menu['inventory']['content']['transport']['page']            = '/front/transport.php';
            $menu['inventory']['content']['transport']['links']['search'] = '/front/transport.php';
           
            if (Session::haveRight("transport","w")) {
                
                $menu['inventory']['content']['transport']['links']['add']
                              = '/front/transport.form.php';
                $menu['inventory']['content']['transport']['links']['template']
                              = '/front/setup.templates.php?'.'itemtype=Transport&amp;add=0';
            }
       ...
       if (Session::haveRight("stock","r")) {
         $menu['inventory']['content']['stock']['title']           = $LANG['Menu'][104];
         $menu['inventory']['content']['stock']['shortcut']        = '';
         $menu['inventory']['content']['stock']['page']            = '/front/stock.php';
         $menu['inventory']['content']['stock']['links']['search'] = '/front/stock.php';
         //$menu['inventory']['content']['cartridge_kit']['links']['summary'] = '/front/stock.php';

         if (Session::haveRight("stock","w")) {
            $menu['inventory']['content']['stock']['links']['add']
                              = '/front/stock.form.php';
            $menu['inventory']['content']['stock']['links']['template']
                              = '/front/setup.templates.php?'.'itemtype=Stock&amp;add=0';
         }
         $showstate = true;
      }
       
       /*if (haveRight("transport","r")) {
        $menu['inventory']['content']['transport']['title']           = $LANG['Menu'][105];
        $menu['inventory']['content']['transport']['shortcut']        = '';
        $menu['inventory']['content']['transport']['page']            = '/front/transport.php';
        $menu['inventory']['content']['transport']['links']['search'] = '/front/transport.php';

        if (haveRight("transport","w")) {
           $menu['inventory']['content']['transport']['links']['add']
                             = '/front/transport.form.php';
           $menu['inventory']['content']['transport']['links']['template']
                             = '/front/setup.templates.php?'.'itemtype=Transport&amp;add=0';
...
//       }
      ...
      if (Session::haveRight("document", "r")) {
		...
		/*//SUPRISERVICE*/
      if (Session::haveRight("contract", "r")) {
         $menu['financial']['default'] = '/front/contract.php';
         $menu['financial']['content']['entitymap']['title']           = $LANG['Menu'][100];
         $menu['financial']['content']['entitymap']['page']            = '/front/entitymap.php';
         $menu['financial']['content']['entitymap']['links']['search'] = '/front/entitymap.php';
      }
		//--
      ...
      if ($CFG_GLPI["use_ocs_mode"] && Session::haveRight("ocsng","w")) {
		...
		/*//SUPRISERVICE*/
      if (Session::haveRight("importacao_dados", "1")) {
         $menu['utils']['content']['import']['title']           = $LANG['Menu'][101];
         $menu['utils']['content']['import']['page']            = '/front/import.php';
         $menu['utils']['content']['import']['links']['search'] = '/front/import.php';
      }
