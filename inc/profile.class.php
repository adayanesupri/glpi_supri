<?php
/*
 * @version $Id: profile.class.php 18771 2012-06-29 08:49:19Z moyo $
 -------------------------------------------------------------------------
...
//       }
   ...
   **/
   function showFormInventory($openform=true, $closeform=true) {
      ...
      /*//SUPRISERVICE*/
      echo "<tr class='tab_bg_2'>";
      echo "<td>Kits de Suprimentos&nbsp;:</td><td>";
      self::dropdownNoneReadWrite("cartridge_kits", $this->fields["cartridge_kits"], 1, 1, 1);
      echo "</td>";
      echo "<td>Peças&nbsp;:</td><td>";
      self::dropdownNoneReadWrite("stock", $this->fields["stock"], 1, 1, 1);
      echo "</td>";
      echo "<td>Veículos&nbsp;:</td><td>";
      self::dropdownNoneReadWrite("transport", $this->fields["transport"], 1, 1, 1);
      echo "</td>";
      echo "<td>";
      echo "</td></tr>\n";
      ...
      self::dropdownNoneReadWrite("clean_ocsng", $this->fields["clean_ocsng"], 1, 1, 1);
		/*//SUPRISERVICE*/
      echo "</td>";
      echo "<td>".$LANG['Menu'][101]."&nbsp;:</td><td>";
      Dropdown::showYesNo("importacao_dados", $this->fields["importacao_dados"]);
      echo "</td>";
      echo "<td colspan='2'>";
      echo "</td></tr>\n";
