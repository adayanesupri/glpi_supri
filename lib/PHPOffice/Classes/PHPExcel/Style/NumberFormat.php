...
class PHPExcel_Style_NumberFormat implements PHPExcel_IComparable
{
	...
	/*//SUPRISERVICE*/
	//const FORMAT_CURRENCY_REAL				= '[$R$ ]#,##0.00_-';
	//const FORMAT_CURRENCY_REAL4				= '[$R$ ]#,##0.000_-';

	const FORMAT_CURRENCY_REAL				= '_-R$ * #,##0.00_-;-R$ * #,##0.00_-;_-R$ * "-"??_-;_-@_-';
	const FORMAT_CURRENCY_REAL4			= '_-R$ * #,##0.000_-;-R$ * #,##0.000_-;_-R$ * "-"??_-;_-@_-';
	const FORMAT_NUMBER_MILHAR				= '#.##0';
