<?php
/*
 * @version $Id: dropdownMassiveAction.php 19256 2012-09-13 09:45:48Z yllen $
 -------------------------------------------------------------------------
...
if (isset($_POST["action"]) && isset($_POST["itemtype"]) && !empty($_POST["itemtype"])) {
   ...
   switch($_POST["action"]) {
		/*//SUPRISERVICE*/
      case "massive_move_to_group" :
         Agrupamento_Supridesk::getDropdown("agrupamentoID", $_POST["extra_contractID"]);
      ...
      case "overwrite_actor" :
         ...
         Ajax::updateItemOnSelectEvent("dropdown_actortype$rand", "show_massiveaction_field",
                                       $CFG_GLPI["root_doc"]."/ajax/dropdownMassiveActionOverwriteActor.php",
                                       $paramsmassaction);
         echo "<span id='show_massiveaction_field'>&nbsp;</span>\n";
      ...
      case "force_user_ldap_update" :
		/*//SUPRISERVICE*/
      case "faturar" :
      case "desvincular_diagnostico" :
      case "desvincular_solucao" :
		//--
      case "delete" :
      case "purge" :
      case "restore" :
